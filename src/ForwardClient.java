...
public class ForwardClient
{
    ...
    private static void doHandshake(Socket handshakeSocket,String targethost, String targetport, String cacert,String usercert,String ClientPrivateKeyFile) throws Exception {
        clientHandshake = new ClientHandshake(handshakeSocket,targethost,targetport,cacert,usercert,ClientPrivateKeyFile);
    }
    ...
    static public void startForwardClient() throws Exception {
        ...
        String ClientPrivateKeyFile=arguments.get("key");
        doHandshake(handshakeSocket,targethost,targetport,cacert,usercert,ClientPrivateKeyFile);
        ...
        ForwardServerClientThread forwardThread =
                new ForwardServerClientThread(proxySocket, clientHandshake.sessionHost, clientHandshake.sessionPort,clientHandshake.sessionKey,clientHandshake.sessionIV);
        /*
         * Launch the fowarder
         */
        forwardThread.start();
